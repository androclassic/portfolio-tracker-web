          ...
          <div className="card">
            ...
            <form onSubmit={handleFetchTrades} style={{ padding: '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              ...
              <div style={{
                ...
                <ol style={{ margin: '0.5rem 0 0', paddingLeft: '1.25rem', lineHeight: 1.8 }}>
                  <li>Go to <a href="https://crypto.com/exchange/personal/api-management" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--primary)' }}>crypto.com/exchange → API Management</a></li>
